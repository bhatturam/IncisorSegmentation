...
class ActiveShapeModel:
    def __init__(self, images, shape_list, grey_model_number_of_pixels=15,
                 ...
                 shape_fit_tol=1e-7, shape_fit_max_iters=10000, simple_model = True
                 ):
        self._grey_model = GreyModel(images, shape_list, grey_model_number_of_pixels,
                                     ...
                                     grey_model_normalize, simple_model)
    ...
    def fit(self, test_image, combined_fit_tol=1e-7, combined_fit_max_iters=10000, initial_shape=None):
